    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'usrtFcstHsts', 
                route: '/weathers/usrtFcstHsts',
                ImageUrl: '',
            },
            { 
                title: 'WeatherStnInfo', 
                description: '', 
                key: 'weatherStnInfos', 
                route: '/weathers/weatherStnInfos',
                ImageUrl: '',
            },
            { 
                title: 'User', 
            ...
            { 
                ...
                description: '', 
                key: 'challengeInfos', 
                route: '/challenges/challengeInfos',
                ImageUrl: '',
            },
            { 
                title: 'ChallengeHst', 
                description: '', 
                key: 'challengeHsts', 
                route: '/challenges/challengeHsts',
                ImageUrl: '',
            },
            { 
